...
func (o PlanOutput) ApiVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Plan) pulumi.StringPtrOutput { return v.ApiVersion }).(pulumi.StringPtrOutput)
}
...
func (o PlanOutput) Metadata() metav1.ObjectMetaPtrOutput {
	return o.ApplyT(func(v *Plan) metav1.ObjectMetaPtrOutput { return v.Metadata }).(metav1.ObjectMetaPtrOutput)
}

func (o PlanOutput) Spec() PlanSpecPtrOutput {
	return o.ApplyT(func(v *Plan) PlanSpecPtrOutput { return v.Spec }).(PlanSpecPtrOutput)
}

func (o PlanOutput) Status() PlanStatusPtrOutput {
	return o.ApplyT(func(v *Plan) PlanStatusPtrOutput { return v.Status }).(PlanStatusPtrOutput)
}
